...
class Listener(StreamListener):
    ...
    def __init__(self, candidates, maximum):
        super(StreamListener, self).__init__() # not sure what this does but it works
        self.candidates = candidates # dictionary of Candidate classes
        self.size = 0
        self.max = maximum
...
if __name__ == "__main__":
    ...
    # initialize stream
    streamer = Listener(candidates, 50)
